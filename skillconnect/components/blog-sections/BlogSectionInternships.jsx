...
export default async function BlogSectionInternships() {
  const data = await getData()
  return (
    <div className="bg-white py-8 sm:py-8">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Launch Your Career with Internships</h2>
            ...
            <article key={post.id} className="flex flex-col items-start justify-between">
              ...
              <div className="max-w-xl">
                <div className="mt-8 flex items-center gap-x-4 text-xs">
                  <time dateTime={post.apply_by} className="text-gray-500">
                    {post.apply_by}
                  </time>
                  <a
                    href={post.stipend}
