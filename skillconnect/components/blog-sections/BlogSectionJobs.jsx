    ...
    <div className="bg-white py-8 sm:py-8">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Find Your Dream Job</h2>
          <p className="mt-2 text-lg leading-8 text-gray-600">
          Explore a vast array of job opportunities from leading companies across various industries.
          </p>
        </div>
            ...
            <article key={post.id} className="flex flex-col items-start justify-between">
              ...
              <div className="max-w-xl">
                <div className="mt-8 flex items-center gap-x-4 text-xs">
                  <time dateTime={post.date_added} className="text-gray-500">
                    {post.date_added}
                  </time>
                  <a
                    href={post.salary}
                ...
                <div className="relative mt-8 flex items-center gap-x-4">
                  <img src={post.company.companylogo} alt="" className="h-10 w-10 rounded-full bg-gray-100" />
                  <div className="text-sm leading-6">
                    <p className="font-semibold text-gray-900">
                      <a href={post.company.companylogo}>
                        <span className="absolute inset-0" />
                        {post.company.companyname}
                      </a>
                    </p>
                    <div className="flex items-center gap-x-1 pt-1 text-xs" >
