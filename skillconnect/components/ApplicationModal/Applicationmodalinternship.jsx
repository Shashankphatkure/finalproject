...
const ApplicationModalInternship = ({ isOpen, onClose, onSubmit, jobid }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const { data, error } = await supabase
      .from("internshipapplications") // Use the name of your table
      .insert([
        {
          cvlink: cvLink,
...
export default ApplicationModalInternship;
