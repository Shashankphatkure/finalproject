              ...
              >
                ...
                <div>
                  ...
                  <div className="group relative max-w-xl">
                    ...
                    <div
                      className="mt-4 flex w-full h-1.5 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-700"
                      role="progressbar"
                      aria-valuenow="25"
                      aria-valuemin="0"
                      aria-valuemax="100"
                  ...
                  <div className="mt-6 flex border-t border-gray-900/5 pt-6">
                    <div className="relative flex items-center gap-x-4">
                      <img
                        src={
                          item.instructor
                            ? item.instructor.instructorimage
                            : "default-instructor-image-url"
                        }
                        alt=""
