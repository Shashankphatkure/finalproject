...
export default async function Jobscard() {
  ...
  <div className="ml-2">
    {renderStars(item.company ? item.company.rating : 'Company not specified')}
  </div>
</h3>
                    <h3 className="text-md font-semibold leading-6 text-gray-600 group-hover:text-gray-600">
                      <a>
                        <span className="absolute inset-0" />{item.company ? item.company.companyname : 'Company not specified'}
                      </a>
                    </h3>
                  ...
                  <div className="mt-3 flex border-t border-gray-900/5 pt-3">
                    <div className="relative flex items-center gap-x-4">
                      ...
                      <img
                      src={item.company ? item.company.companylogo : 'default-company-logo-url'}
                      alt=""
