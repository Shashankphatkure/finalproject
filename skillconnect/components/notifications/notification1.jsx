...
export default function Notification1() {
  ...
  return (
    <>
      ...
      <div 
        aria-live="assertive"
        className="pointer-events-none z-10 fixed inset-0 flex items-end px-4 py-6 sm:items-start sm:p-6"
      >
              ...
              <div className="p-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 w-0 flex-1">
                    <p className="text-sm font-medium text-gray-900">Emilia Gates {count}</p>
