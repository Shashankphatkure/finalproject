  ...
  export default async function Page({ params }) {
    ...
    <div className="flex min-h-full flex-col">
      ...
      <div className="mx-auto flex w-full max-w-7xl items-start gap-x-8 px-4 py-10 sm:px-6 lg:px-8">
        ...
        <Pageheadings2 title={item.title} stipend={item.stipend} duration={item.duration} start_date={item.start_date}/>
        <div className="mt-6" />
        <DescriptionList opening={item.opening} companyid={item.companyid} />
        </main>
