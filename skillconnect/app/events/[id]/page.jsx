...
async function getData(id) {
  // Fetch event data along with the category using a single query
...
<div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <div className="grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center ">
    <div className="lg:col-span-3 ">
      <p className="mt-3 text-lg text-gray-800 dark:text-gray-400">{new Date(item.date_and_time).toLocaleDateString('en-US', {
    weekday: 'long',
    month: 'long',
    day: 'numeric',
      })} | {item.category}_</p>
      <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl md:text-5xl lg:text-6xl dark:text-white">{item.title}</h1>
          <p className="mt-3 text-lg text-gray-800 dark:text-gray-400">{item.description}</p>
<br/>

<div className="flex flex-wrap space-x-4">
<div className="w-2/3 py-2 px-3 bg-white border border-gray-200 rounded-lg dark:bg-slate-900 dark:border-gray-700" data-hs-input-number>
  <div className="w-full flex justify-between items-center gap-x-3">
    ...
    <div className="flex items-center gap-x-1.5">
      ...
      <input className="p-0 w-6 bg-transparent border-0 text-gray-800 text-center focus:ring-0 dark:text-white" type="text" value="1" data-hs-input-number-input></input>
  ...
  <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m5 11 4-7"/><path d="m19 11-4-7"/><path d="M2 11h20"/><path d="m3.5 11 1.6 7.4a2 2 0 0 0 2 1.6h9.8c.9 0 1.8-.7 2-1.6l1.7-7.4"/><path d="m9 11 1 9"/><path d="M4.5 15.5h15"/><path d="m15 11-1 9"/></svg>
      ...
      <div class="p-4 md:p-5">
        <div class="flex">
          ...
          <div class="grow ms-5">
            ...
            {new Date(item.date_and_time).toLocaleDateString('en-US', {
    weekday: 'long',
    month: 'long',
    day: 'numeric',
  })} · 4:30 - 7pm IST
    ...
    <div className="lg:col-span-4 mt-20 mb-10 lg:mt-0">
      <img class="w-full rounded-xl" src={item.thumbnail} alt="Image Description"></img>
    </div>
        ...
        <div className="sticky top-0 start-0 py-8 lg:ps-8">
          ...
          <div className="group flex items-center gap-x-3 border-b border-gray-200 pb-8 mb-8 dark:border-gray-700">
            ...
            <a className="group grow block" href="">
              ...
              <p className="text-sm text-gray-500">{item.users.role}</p>
            </a>
            <div className="grow">
          ...
          {/* End Avatar Media */}
                <div className="space-y-6">
                  <p>More events from the organizer</p>
            {/* Media */}
