...
import StepperVerticalWithNumbersJob from 'src/views/forms/form-wizard/StepperVerticalWithNumbersJobs'
import StepperVerticalWithNumbersInternship from 'src/views/forms/form-wizard/StepperVerticalWithNumbersInternships'
...
const Pricing = ({ apiData }) => {
  ...
  return (
    <Grid>
      <Grid item>
        <StepperVerticalWithNumbersInternship />
      </Grid>
    </Grid>
  )
}
