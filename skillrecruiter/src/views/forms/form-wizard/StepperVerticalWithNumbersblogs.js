...
const StepperVerticalWithNumbersBlog = () => {
  // ** States
  ...
  return (
    <Card>
      <CardHeader title='Add new blog post' />
      <CardContent>
        <StepperWrapper>
              ...
              return (
                <Step key={index} className={clsx({ active: activeStep === index })}>
                  ...
                  <StepContent>
                    ...
                    {activeStep === 0 && (
                      <TextField sx={{ mt: 2 }} label='Featured Image' variant='outlined' fullWidth />
                    )}

                    {activeStep === 0 && <TextField sx={{ mt: 2 }} label='Video link' variant='outlined' fullWidth />}

                    {activeStep === 0 && <TextField sx={{ mt: 2 }} label='Category' variant='outlined' fullWidth />}
                    ...
                    {activeStep === 2 && <TextField sx={{ mt: 2 }} label='Meta Title' variant='outlined' fullWidth />}
                    ...
                    {activeStep === 2 && (
                      <TextField sx={{ mt: 2 }} label='Related posts' variant='outlined' fullWidth />
                    )}
...
export default StepperVerticalWithNumbersBlog
